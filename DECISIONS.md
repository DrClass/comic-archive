...
4. **Preserve original media formats, including safe PDF-contained page images.** JPG/JPEG/PNG/WEBP/GIF/MP4 are copied. Simple image-only PDF pages directly preserve embedded JPEG/PNG data when safe; other PDF pages render to high-quality JPEG. General conversion is not desired. CBZ is not currently required.
